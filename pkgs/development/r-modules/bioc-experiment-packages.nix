...
in with self; {
  ...
  BeadArrayUseCases = derive2 { name="BeadArrayUseCases"; version="1.42.0"; sha256="1s62vqvl3zxf97syp5lymacah594m8szk23skl4bk88jkzkkx6a5"; depends=[GEOquery beadarray limma]; };
  ...
  BioImageDbs = derive2 { name="BioImageDbs"; version="1.12.0"; sha256="1cs6c80h34xbzpsgrpy5aj1f0nlxmy713jj1q5g156z5kiz3mzwc"; depends=[AnnotationHub EBImage ExperimentHub animation einsum filesstrings magick magrittr markdown rmarkdown]; };
  BioPlex = derive2 { name="BioPlex"; version="1.10.0"; sha256="1bkakf7yi1lhwc48pmwifk7qdnc9hzaqnlcni7sy0ypwgb1mfsh7"; depends=[BiocFileCache GEOquery GenomeInfoDb GenomicRanges SummarizedExperiment graph]; };
  BloodCancerMultiOmics2017 = derive2 { name="BloodCancerMultiOmics2017"; version="1.24.0"; sha256="16c6nirflpj0zf2wrj0hb5xcq2168si95np3sm76r3kvwlr48zm7"; depends=[Biobase DESeq2 RColorBrewer SummarizedExperiment beeswarm devtools dplyr ggdendro ggplot2 glmnet gtable ipflasso reshape2 scales survival tibble]; };
  CCl4 = derive2 { name="CCl4"; version="1.42.0"; sha256="0n3kx176if48gmw3qd5knlv5q7v7738c54ix8cwr2xhsqc7ah800"; depends=[Biobase limma]; };
  CLL = derive2 { name="CLL"; version="1.44.0"; sha256="18bjaqf6cjvjfcp80b5zmb48qbywacqs6aiarsh6ksq2yj4np4zs"; depends=[Biobase affy]; };
  ...
  CoSIAdata = derive2 { name="CoSIAdata"; version="1.4.1"; sha256="094f3b2r659q3mlrzm6n2wvw13x8l1gll42a8win8kqbnkdd3jmj"; depends=[ExperimentHub]; };
  ...
  DNAZooData = derive2 { name="DNAZooData"; version="1.4.0"; sha256="1bs2pnak2v2szp7zly8ysf8pqh7f70w70cbqqzvnxlf35npv7cxd"; depends=[BiocFileCache HiCExperiment S4Vectors rjson]; };
  DeSousa2013 = derive2 { name="DeSousa2013"; version="1.40.0"; sha256="1icjl4rr8jk16hs8ri925v3gf9lasi4x39yf5a7av39byb2zwqif"; depends=[AnnotationDbi Biobase ConsensusClusterPlus ROCR affy cluster frma frmaTools gplots hgu133plus2_db hgu133plus2frmavecs pamr rgl siggenes survival sva]; };
  DmelSGI = derive2 { name="DmelSGI"; version="1.36.0"; sha256="0xjj2ky0k8vazw97qsaf79c6cc3whxg0n5v6lrj6slk4hyfcmbw4"; depends=[TSP abind gplots igraph knitr limma rhdf5]; };
  ...
  DuoClustering2018 = derive2 { name="DuoClustering2018"; version="1.22.0"; sha256="042v3dpirp68qsdbhygvx3apx94xxdmzpm0swii30kzkw1r1xfck"; depends=[ExperimentHub dplyr ggplot2 ggthemes magrittr mclust purrr reshape2 tidyr viridis]; };
  ...
  EatonEtAlChIPseq = derive2 { name="EatonEtAlChIPseq"; version="0.42.0"; sha256="109law5cc64xipwqyanw71h8v5nx08s1iaskh05hm1w18dsjxff1"; depends=[GenomicRanges ShortRead rtracklayer]; };
  ...
  Fletcher2013a = derive2 { name="Fletcher2013a"; version="1.40.0"; sha256="0l839hd76xr94qjcnscr9c40nvsx99ir6vsy1zx6dn7cha52mpar"; depends=[Biobase VennDiagram gplots limma]; };
  Fletcher2013b = derive2 { name="Fletcher2013b"; version="1.40.0"; sha256="0agnkc207bma3h89xxrzcywny664f42vfd63qnmyda4kvdvvk0km"; depends=[Fletcher2013a RColorBrewer RTN RedeR igraph]; };
  ...
  FlowSorted_Blood_EPIC = derive2 { name="FlowSorted.Blood.EPIC"; version="2.8.0"; sha256="1b0azyslk2g08i6v1vv2niw32f0zqasw85b9klw83zdy2f5dcdvh"; depends=[AnnotationHub ExperimentHub S4Vectors SummarizedExperiment genefilter minfi nlme quadprog]; };
  ...
  GSE13015 = derive2 { name="GSE13015"; version="1.12.0"; sha256="0l1v30g1g93wk5bnhkw52pwypby6n0rxpp11aw93j733whn9j2y4"; depends=[Biobase GEOquery SummarizedExperiment preprocessCore]; };
  ...
  GenomicDistributionsData = derive2 { name="GenomicDistributionsData"; version="1.12.0"; sha256="16cj8w6n053aciz9wclppmc22b9s4a9lh58r6wi2lhs0sp7iirzn"; depends=[AnnotationFilter AnnotationHub BSgenome ExperimentHub GenomeInfoDb GenomicFeatures GenomicRanges data_table ensembldb]; };
  ...
  HCATonsilData = derive2 { name="HCATonsilData"; version="1.2.0"; sha256="1wg0mvc3gwf80bgsfkvdcnnzy7qbnffbbrcy3f87jyw4a20irpp1"; depends=[ExperimentHub HDF5Array S4Vectors SingleCellExperiment SpatialExperiment SummarizedExperiment base64enc htmltools rmarkdown]; };
  HD2013SGI = derive2 { name="HD2013SGI"; version="1.44.0"; sha256="0r4nlbz7b70z1ii9wisk8nj218m2j5qmpfj8k2sp8k723gmsg4x0"; depends=[EBImage LSD RColorBrewer geneplotter gplots limma splots vcd]; };
  HDCytoData = derive2 { name="HDCytoData"; version="1.24.0"; sha256="0pmzgp7x1zam3b7agi8mdq14qmx8nln9lnhiglax2pvg2a5n4ii4"; depends=[ExperimentHub SummarizedExperiment flowCore]; };
  ...
  HMP16SData = derive2 { name="HMP16SData"; version="1.24.0"; sha256="16x7mw5bdsyda1qv0v739pkr8lxq8hga84vhmaa8qnx45pwqyyh0"; depends=[AnnotationHub ExperimentHub S4Vectors SummarizedExperiment assertthat dplyr kableExtra knitr magrittr readr stringr tibble]; };
  HMP2Data = derive2 { name="HMP2Data"; version="1.18.0"; sha256="014bf29kg9dizi3p0fdxrs42bf9a0dc2f7zd7yxzvzs3jqvniji2"; depends=[AnnotationHub ExperimentHub MultiAssayExperiment S4Vectors SummarizedExperiment assertthat data_table dplyr kableExtra knitr magrittr phyloseq readr]; };
  ...
  HiBED = derive2 { name="HiBED"; version="1.2.0"; sha256="0sqxlm2nn8g7qfwhndf79dg7v57ngmznr0b297v59nhhpigs1g2q"; depends=[AnnotationHub FlowSorted_Blood_EPIC FlowSorted_DLPFC_450k SummarizedExperiment dplyr minfi tibble]; };
  ...
  Hiiragi2013 = derive2 { name="Hiiragi2013"; version="1.40.0"; sha256="0xn3ayh2x04cvwrr476k8vlp8lhk5lxaqg01a0ynkrrc4scf2f99"; depends=[Biobase KEGGREST MASS RColorBrewer affy boot clue cluster genefilter geneplotter gplots gtools lattice latticeExtra mouse4302_db xtable]; };
  ...
  IHWpaper = derive2 { name="IHWpaper"; version="1.32.0"; sha256="0s3x2chbr8ik3rhgzmfhaq8xlsnnkzfhjh4p327sn5aar6xhaj67"; depends=[Biobase BiocGenerics BiocParallel DESeq2 IHW Rcpp SummarizedExperiment cowplot dplyr fdrtool genefilter ggplot2 qvalue]; };
  ...
  JohnsonKinaseData = derive2 { name="JohnsonKinaseData"; version="1.0.0"; sha256="1ry5p2zll8hazxil4sa57v50b7xr9bk4p5a509i4mvasb089al3l"; depends=[BiocParallel ExperimentHub checkmate dplyr purrr stringr tidyr]; };
  ...
  MAQCsubset = derive2 { name="MAQCsubset"; version="1.42.0"; sha256="0x59gbv91d90hasa2gwkv00c06zp8fj4fk18386ajfag0wpvpb2n"; depends=[Biobase affy lumi]; };
  ...
  MetaGxBreast = derive2 { name="MetaGxBreast"; version="1.24.0"; sha256="05cz500r6fhlq5pfviiqj8cfv173027dqsdvhvvi57cbbx3qqn6r"; depends=[AnnotationHub Biobase ExperimentHub SummarizedExperiment impute lattice]; };
  MetaGxOvarian = derive2 { name="MetaGxOvarian"; version="1.24.0"; sha256="01cnm2rf6ls1q5plgazxqkrrw3b6mcrxbq0wrmi0ra8daqh6asi7"; depends=[AnnotationHub Biobase ExperimentHub SummarizedExperiment impute lattice]; };
  MetaGxPancreas = derive2 { name="MetaGxPancreas"; version="1.24.0"; sha256="150i72jrq3qshsh0m20kxdcx7zxz1cgvlk0y2nxnacs1xbdnywxv"; depends=[AnnotationHub ExperimentHub S4Vectors SummarizedExperiment impute]; };
  MetaScope = derive2 { name="MetaScope"; version="1.4.0"; sha256="1kaisvhp66g95w4dycw8jzsxh00f2c193rjcla6l5k2dn5rnsyr9"; depends=[BiocFileCache Biostrings Matrix MultiAssayExperiment Rbowtie2 Rsamtools S4Vectors SummarizedExperiment data_table dplyr ggplot2 magrittr readr rlang stringr taxize tibble tidyr]; };
  ...
  MethylSeqData = derive2 { name="MethylSeqData"; version="1.14.0"; sha256="197347pavq9hjcpwa9lq66lyjr1jb7mymd9pjz01rr9f77d7rqq5"; depends=[ExperimentHub GenomeInfoDb GenomicRanges HDF5Array IRanges S4Vectors SummarizedExperiment rhdf5]; };
  MicrobiomeBenchmarkData = derive2 { name="MicrobiomeBenchmarkData"; version="1.6.0"; sha256="00lr183x24yx4xd9cpxvzkcxmqp4dinfi1nz2arqqxnbfcp2s25j"; depends=[BiocFileCache S4Vectors SummarizedExperiment TreeSummarizedExperiment ape]; };
  ...
  NestLink = derive2 { name="NestLink"; version="1.20.0"; sha256="1yh1nivipyrx3h0par8cf943licl1rs47jvfwz1392hi09vji15j"; depends=[AnnotationHub Biostrings ExperimentHub ShortRead gplots protViz]; };
  ...
  Neve2006 = derive2 { name="Neve2006"; version="0.42.0"; sha256="0w3ph610lhxyg1knhsnnxpw32sw2n5p57svpbhqm3zmphx29nw3h"; depends=[Biobase annotate hgu133a_db]; };
  ...
  PREDAsampledata = derive2 { name="PREDAsampledata"; version="0.44.0"; sha256="0ydb4y2s8kshia7k6mr941f1fc7nsqahm1g86ig3wpcq7al33z1b"; depends=[Biobase PREDA affy annotate]; };
  ...
  RNAinteractMAPK = derive2 { name="RNAinteractMAPK"; version="1.42.0"; sha256="0vm20x1lfgl671rrwvxybcwjgk7falb3d5xi6hiq9jivvbms9120"; depends=[Biobase MASS RNAinteract fields gdata genefilter lattice sparseLDA]; };
  ...
  ReactomeGSA_data = derive2 { name="ReactomeGSA.data"; version="1.18.0"; sha256="1410ks6s7albf6sly8ry0ln58ws9jlfn62amniqqsg46kx4xc4bh"; depends=[ReactomeGSA Seurat edgeR limma]; };
  ...
  RforProteomics = derive2 { name="RforProteomics"; version="1.42.0"; sha256="0irg6wrwy82xhlkgj1vphh6ncp9s6qcpp40mxv1vq969qjjchkk9"; depends=[BiocManager MSnbase R_utils biocViews]; };
  ...
  SpikeInSubset = derive2 { name="SpikeInSubset"; version="1.44.0"; sha256="118v972wwq4h2ww2nlb7mzva3d38c4hzmbq0v28500q2zc1ykv4l"; depends=[Biobase affy]; };
  SubcellularSpatialData = derive2 { name="SubcellularSpatialData"; version="1.0.0"; sha256="0lyg6hiv8ch7c8a7zzi02c9fmq2zqif88khhslj15gvg5dznw79v"; depends=[Matrix SpatialExperiment dplyr hexbin]; };
  ...
  TabulaMurisSenisData = derive2 { name="TabulaMurisSenisData"; version="1.10.0"; sha256="1b1aj06qacvzpabz8r0vkqpm0pp48vx26xx84h5ihzg9232wrqmy"; depends=[AnnotationHub ExperimentHub HDF5Array SingleCellExperiment SummarizedExperiment gdata]; };
  ...
  TumourMethData = derive2 { name="TumourMethData"; version="1.2.0"; sha256="1xwm2amlb1vrf3hpdw9387nglc6pbxxdxik56byr5p8856fkjdav"; depends=[ExperimentHub GenomicRanges HDF5Array R_utils SummarizedExperiment rhdf5]; };
  ...
  XhybCasneuf = derive2 { name="XhybCasneuf"; version="1.42.0"; sha256="0n0k6h9b9gkywy6cmlx15g09287aqzvc228j3jgjkv0ljbwsq756"; depends=[RColorBrewer affy ath1121501cdf tinesath1cdf]; };
  ...
  affycompData = derive2 { name="affycompData"; version="1.42.0"; sha256="16fri51jhp0lm3aj9hw2s6jzxjlxz2qbd36j9zcbcs7sb6jh42jy"; depends=[Biobase affycomp]; };
  ...
  beadarrayExampleData = derive2 { name="beadarrayExampleData"; version="1.42.0"; sha256="0l5n1d7x4gc3w2kc6vq0gqxp1wdpa2sn5k75yf5fc802m11nrkd1"; depends=[Biobase beadarray]; };
  ...
  biscuiteerData = derive2 { name="biscuiteerData"; version="1.18.0"; sha256="1qv2ajy312diacb3mihc3q7hrrlq48k5vd9v0g6w38cqz6gnz0as"; depends=[AnnotationHub ExperimentHub GenomicRanges curl]; };
  ...
  celldex = derive2 { name="celldex"; version="1.14.0"; sha256="155hnh62ra06b52xk78f111b10gm34d1djvl5w5mabvrk4vknwj6"; depends=[AnnotationDbi AnnotationHub DBI DelayedArray DelayedMatrixStats ExperimentHub Matrix RSQLite S4Vectors SummarizedExperiment alabaster_base alabaster_matrix alabaster_se gypsum jsonlite]; };
  ...
  chipenrich_data = derive2 { name="chipenrich.data"; version="2.28.0"; sha256="1kpc3ljayxycadshdgyzkbagh4vd7cmyqqccy61269skpasdnwbv"; depends=[AnnotationDbi BiocGenerics GenomeInfoDb GenomicRanges IRanges S4Vectors readr rtracklayer]; };
  ...
  curatedBreastData = derive2 { name="curatedBreastData"; version="2.32.0"; sha256="0zglh1h9hw6rnpdl4v5v7cmzgcvxa0phfixfwwmi8il0rn40jd68"; depends=[Biobase BiocStyle XML ggplot2 impute]; };
  ...
  curatedMetagenomicData = derive2 { name="curatedMetagenomicData"; version="3.12.0"; sha256="1hp1s5v567xidmmpn6jv7i3fid5hwg3i43y9471aabq00nsg67b1"; depends=[AnnotationHub ExperimentHub S4Vectors SummarizedExperiment TreeSummarizedExperiment dplyr magrittr mia purrr rlang stringr tibble tidyr tidyselect]; };
  ...
  curatedPCaData = derive2 { name="curatedPCaData"; version="1.0.4"; sha256="180lhsh2si7vnr2xysb4225rbympx32kgxxvkis66r26qxr9z144"; depends=[AnnotationHub ExperimentHub MultiAssayExperiment RaggedExperiment S4Vectors reshape2 rlang]; };
  ...
  depmap = derive2 { name="depmap"; version="1.18.0"; sha256="0imajc5kiqf45sjwxagvg5bjvmnrzrk3ls4bflwxj9rnd84v2r62"; depends=[AnnotationHub BiocFileCache ExperimentHub curl dplyr httr2 tibble]; };
  ...
  emtdata = derive2 { name="emtdata"; version="1.12.0"; sha256="0b3hvggndw3bzddk0vflbn0wx8fr08b6nphjhil1wqlyp3535xk4"; depends=[ExperimentHub SummarizedExperiment edgeR]; };
  ...
  furrowSeg = derive2 { name="furrowSeg"; version="1.32.0"; sha256="125wyqi4h7kkrhbcn4gknwlw6panian2hfsapwyqfxz0mg6ssg5z"; depends=[EBImage abind dplyr locfit tiff]; };
  ...
  healthyControlsPresenceChecker = derive2 { name="healthyControlsPresenceChecker"; version="1.8.0"; sha256="14gq24z99l04kcn13414zjn17184l3p5l6draxwy3820m9sijzgq"; depends=[GEOquery geneExpressionFromGEO magrittr xml2]; };
  ...
  homosapienDEE2CellScore = derive2 { name="homosapienDEE2CellScore"; version="1.0.0"; sha256="1vwasylfqv4xgmhkzykdwhlxh0kk4pl4bcndx5dpn7i386zp6chs"; depends=[BiocGenerics DESeq2 ExperimentHub MatrixGenerics Rtsne S4Vectors SummarizedExperiment getDEE2]; };
  ...
  imcdatasets = derive2 { name="imcdatasets"; version="1.12.0"; sha256="135sffkn322g6zp6wz6ri2cg4wj9pwadmv4b6zaaxwximpx5xy04"; depends=[DelayedArray ExperimentHub HDF5Array S4Vectors SingleCellExperiment SpatialExperiment cytomapper]; };
  kidpack = derive2 { name="kidpack"; version="1.46.0"; sha256="0802kn1n9ivjil19faphg4z4iy0y7n1hmixd9bkfv7livfl8yn0b"; depends=[Biobase]; };
  leeBamViews = derive2 { name="leeBamViews"; version="1.40.0"; sha256="15prksw8pi302i8qpw3skwljyj3hfm9wld2lzpcgz7nnpzrqm8bc"; depends=[BSgenome Biobase GenomicAlignments GenomicRanges IRanges Rsamtools S4Vectors]; };
  ...
  microbiomeDataSets = derive2 { name="microbiomeDataSets"; version="1.12.1"; sha256="1jc5xcf48xwa7m1g55z38mjnbsqj7gqzwdb37kg1q60rk6bj4mj2"; depends=[BiocGenerics Biostrings ExperimentHub MultiAssayExperiment SummarizedExperiment TreeSummarizedExperiment ape]; };
  ...
  mvoutData = derive2 { name="mvoutData"; version="1.40.0"; sha256="01rxr4867w2zcy4gmcg868g2xqal5vb4xw2izfmcwplxah5380wv"; depends=[Biobase affy lumi]; };
  ...
  orthosData = derive2 { name="orthosData"; version="1.2.0"; sha256="000jqijl7mpp0qfgg0aqx7jzn5bviybp2ndxmikyn0rmcvi9057k"; depends=[AnnotationHub BiocFileCache ExperimentHub HDF5Array SummarizedExperiment stringr]; };
  ...
  pd_atdschip_tiling = derive2 { name="pd.atdschip.tiling"; version="0.42.0"; sha256="17sf3x7mhkjk605hmc0idx1d3pbx49hyfaxzifkc6bq1mmq5113x"; depends=[Biostrings DBI IRanges RSQLite S4Vectors oligo oligoClasses]; };
  ...
  qPLEXdata = derive2 { name="qPLEXdata"; version="1.22.0"; sha256="1a8mzbll0s9w82y4sy153jna6677sdpp3bfzs83qaqpnjymjzfpc"; depends=[MSnbase dplyr knitr qPLEXanalyzer]; };
  rRDPData = derive2 { name="rRDPData"; version="1.24.0"; sha256="030hnp9sghl0f2wfg243ll6myp9gr5zzbwlfzaz8m7q8xk2if363"; depends=[rRDP]; };
  raerdata = derive2 { name="raerdata"; version="1.2.0"; sha256="15j7sw3kvgqqb7m4y4kn40p8g8s1f204lfnb5zskkjfakj6c2j03"; depends=[BiocGenerics ExperimentHub Rsamtools SingleCellExperiment rtracklayer]; };
  ...
  scATAC_Explorer = derive2 { name="scATAC.Explorer"; version="1.10.0"; sha256="0s2w9b9bb1bzqnlhlrgvp17bifhryvymzaid02ypkqaql06d6nyx"; depends=[BiocFileCache Matrix S4Vectors SingleCellExperiment data_table]; };
  scMultiome = derive2 { name="scMultiome"; version="1.4.2"; sha256="1lmly57dabvh2wcd8nhc7wksppx54v1xkk90izpv3i2k8gpyiwsx"; depends=[AnnotationHub AzureStor DelayedArray ExperimentHub GenomicRanges HDF5Array MultiAssayExperiment S4Vectors SingleCellExperiment SummarizedExperiment checkmate rhdf5]; };
  scRNAseq = derive2 { name="scRNAseq"; version="2.18.0"; sha256="0jsq037ba4xsb3bwwf021jw2hqv30vb5nrjag97xadx75z5fzqlr"; depends=[AnnotationDbi AnnotationHub BiocGenerics DBI DelayedArray ExperimentHub GenomicFeatures GenomicRanges Matrix RSQLite S4Vectors SingleCellExperiment SparseArray SummarizedExperiment alabaster_base alabaster_matrix alabaster_sce ensembldb gypsum jsonlite]; };
  ...
  sesameData = derive2 { name="sesameData"; version="1.22.0"; sha256="05k67isysszzfkkbi811dkab0cmxnwz81p2ldcqz3gsq5qin3p1g"; depends=[AnnotationHub ExperimentHub GenomeInfoDb GenomicRanges IRanges S4Vectors readr stringr]; };
  ...
  signatureSearchData = derive2 { name="signatureSearchData"; version="1.18.0"; sha256="11y1dbixj9b91whzq4lrmad5f4f6gqdv70ar4rg20ql1699dx5l5"; depends=[Biobase ExperimentHub R_utils affy dplyr limma magrittr rhdf5]; };
  ...
  spatialLIBD = derive2 { name="spatialLIBD"; version="1.16.2"; sha256="0bbwh9mfz7iscv8a1jlc7g1c452hv4qr95hwv3z6h2mqf8pcr5g8"; depends=[AnnotationHub BiocFileCache BiocGenerics DT ExperimentHub GenomicRanges IRanges Matrix MatrixGenerics RColorBrewer S4Vectors SingleCellExperiment SpatialExperiment SummarizedExperiment benchmarkme cowplot edgeR fields ggplot2 golem jsonlite limma magick paletteer plotly png rlang rtracklayer scater scuttle sessioninfo shiny shinyWidgets statmod tibble viridisLite]; };
  ...
  tuberculosis = derive2 { name="tuberculosis"; version="1.10.0"; sha256="1l9gm8jlvall905053mmbn0wd053ssnsxy74gza37w669il85awn"; depends=[AnnotationHub ExperimentHub S4Vectors SummarizedExperiment dplyr magrittr purrr rlang stringr tibble tidyr]; };
  ...
  SCATEData = derive2 { name="SCATEData"; version="1.12.0"; sha256="1anvi595r0y6k9qlq1jzg57p5rw29p04m2na4mgvh9yz9yc7acll"; depends=[ExperimentHub GenomicAlignments GenomicRanges]; broken = true; };
