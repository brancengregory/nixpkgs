...
in with self; {
  ...
  MetaScope = derive2 { name="MetaScope"; version="1.2.0"; sha256="0wpp2h3zldvcw9r8bjbbpcvkd3hgh11dp8qalcbm36kx4djc2d1a"; depends=[BiocFileCache Biostrings data_table dplyr ggplot2 magrittr Matrix MultiAssayExperiment qlcMatrix Rbowtie2 readr rlang Rsamtools S4Vectors stringr SummarizedExperiment taxize tidyr]; };
  ...
  SCATEData = derive2 { name="SCATEData"; version="1.12.0"; sha256="1anvi595r0y6k9qlq1jzg57p5rw29p04m2na4mgvh9yz9yc7acll"; depends=[ExperimentHub GenomicAlignments GenomicRanges]; };
  ...
  multiWGCNAdata = derive2 { name="multiWGCNAdata"; version="1.0.0"; sha256="0ix39156llxiwiaj4sddwmj07wvy6nbrcnwp8bynsd8wmybsyv8b"; depends=[ExperimentHub]; };
  ...
  scMultiome = derive2 { name="scMultiome"; version="1.2.0"; sha256="character(0)"; depends=[AnnotationHub AzureStor checkmate DelayedArray ExperimentHub GenomicRanges HDF5Array MultiAssayExperiment rhdf5 S4Vectors SingleCellExperiment SummarizedExperiment]; };
