...
let
  ...
  deriveCran = mkDerive {
    ...
    mkUrls = {name, version}: [
      "https://packagemanager.posit.co/cran/2024-04-29/src/contrib/${name}_${version}.tar.gz"
      "https://packagemanager.posit.co/cran/2024-04-29/src/contrib/Archive/${name}/${name}_${version}.tar.gz"
    ];
  };
