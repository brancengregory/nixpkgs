...
in with self; {
  ...
  AHEnsDbs = derive2 { name="AHEnsDbs"; version="1.0.18"; sha256="08n2p2xm7s75q5ps4w9dqg4p3w3baz187n3s5g8rpmd5d2i4zy8r"; depends=[AnnotationHubData ensembldb]; };
  ...
  GO_db = derive2 { name="GO.db"; version="3.12.1"; sha256="1ffsf7cnfi3jlwbpkbayw59wwkzpvw9p929c8gwrc86ksdcnjcg0"; depends=[AnnotationDbi]; };
  GenomeInfoDbData = derive2 { name="GenomeInfoDbData"; version="1.2.4"; sha256="0wi92x3cgf8wgik67g863y53k097hr9cjh06s2dqayivs3hwx7ls"; depends=[]; };
  ...
  LRBase_Ath_eg_db = derive2 { name="LRBase.Ath.eg.db"; version="2.0.0"; sha256="13cjh9nrdww0mz6v1187zal9l2q6phicj54b7qcwbxblvz5byakv"; depends=[LRBaseDbi RSQLite]; };
  LRBase_Bta_eg_db = derive2 { name="LRBase.Bta.eg.db"; version="2.0.0"; sha256="094wnmlgq14cdff6pia8dl4y1127fwxn1cn02p6p8db47bh5vv1a"; depends=[LRBaseDbi RSQLite]; };
  LRBase_Cel_eg_db = derive2 { name="LRBase.Cel.eg.db"; version="2.0.0"; sha256="0z9xmws8dw8kzjy4qmnlm46rmzn0a4bqazm4yy6jpyq69iqi7mfp"; depends=[LRBaseDbi RSQLite]; };
  LRBase_Dme_eg_db = derive2 { name="LRBase.Dme.eg.db"; version="2.0.0"; sha256="0zn5mnp7avz0d288ilibg4955cw5g90yk72img5hs9sscc7kl7zk"; depends=[LRBaseDbi RSQLite]; };
  LRBase_Dre_eg_db = derive2 { name="LRBase.Dre.eg.db"; version="2.0.0"; sha256="1kvvyc7rf159npfi93vvng9c6yn33ngpmjqzqxfjanli2wmspc2q"; depends=[LRBaseDbi RSQLite]; };
  LRBase_Gga_eg_db = derive2 { name="LRBase.Gga.eg.db"; version="2.0.0"; sha256="0khgsjsp3bn6j81rkzljffz7hr25grkw299hh7ja79jkhh2naibs"; depends=[LRBaseDbi RSQLite]; };
  LRBase_Hsa_eg_db = derive2 { name="LRBase.Hsa.eg.db"; version="2.0.0"; sha256="046fgcdnr4yk9gpgk1v6gpg2mv7jb27zlxyqrwf9mcmr28m7f13p"; depends=[LRBaseDbi RSQLite]; };
  LRBase_Mmu_eg_db = derive2 { name="LRBase.Mmu.eg.db"; version="2.0.0"; sha256="0lklf8bilbcf1xbb7ggry8x9pd6qwgv5w19pddgl1ns9dgn0g447"; depends=[LRBaseDbi RSQLite]; };
  LRBase_Pab_eg_db = derive2 { name="LRBase.Pab.eg.db"; version="2.0.0"; sha256="1ig17q920l670kbrinf2939cpvlbdf3zz01fj4bmf1sw4b58v5zh"; depends=[LRBaseDbi RSQLite]; };
  LRBase_Rno_eg_db = derive2 { name="LRBase.Rno.eg.db"; version="2.0.0"; sha256="0rjm5b63hb1h0kkjqxrldh3d2h7l6qqx2cdl3lf2hn1rpfgifxrk"; depends=[LRBaseDbi RSQLite]; };
  LRBase_Ssc_eg_db = derive2 { name="LRBase.Ssc.eg.db"; version="2.0.0"; sha256="0k5dkflsxg0bs2aqcsh0b3vq2clycpxqj138rs6h0w8gr9613w5m"; depends=[LRBaseDbi RSQLite]; };
  LRBase_Xtr_eg_db = derive2 { name="LRBase.Xtr.eg.db"; version="2.0.0"; sha256="1y6nivswrsivlylc9413bngli5nbbd1q6rvr5whx3rh9rxvm4r17"; depends=[LRBaseDbi RSQLite]; };
  ...
  MeSH_AOR_db = derive2 { name="MeSH.AOR.db"; version="1.15.0"; sha256="0sjgjv48qdyhkmaiypqc6v1mi1hdrncz7ff1pjz77xgblpyhcxf5"; depends=[MeSHDbi]; };
  MeSH_Aca_eg_db = derive2 { name="MeSH.Aca.eg.db"; version="1.15.0"; sha256="13di3ljv7l3nq5li2qcb3r4y0d205hjl00ys0g26inp86qda5bnj"; depends=[MeSHDbi]; };
  MeSH_Aga_PEST_eg_db = derive2 { name="MeSH.Aga.PEST.eg.db"; version="1.15.0"; sha256="1qbhki6q2hl3vhyl1aaz722aqn5imb45qp7apypyf0qpy8f3jm15"; depends=[MeSHDbi]; };
  MeSH_Ame_eg_db = derive2 { name="MeSH.Ame.eg.db"; version="1.15.0"; sha256="0dg0rllh3q1pn9vlji5mymix5kvynwx16jhy8rxm0h7swz1bvkvc"; depends=[MeSHDbi]; };
  MeSH_Aml_eg_db = derive2 { name="MeSH.Aml.eg.db"; version="1.15.0"; sha256="1pq6gyv01hwhbmkyhm23j4gl68mdj2rs97b7iv0bfnyvky1qydw4"; depends=[MeSHDbi]; };
  MeSH_Ana_eg_db = derive2 { name="MeSH.Ana.eg.db"; version="1.15.0"; sha256="07iqhj76l8bpxjlfdpzd1nn1jf7mwlikdcnb8a7b4ffw5bcnss2r"; depends=[MeSHDbi]; };
  MeSH_Ani_FGSC_eg_db = derive2 { name="MeSH.Ani.FGSC.eg.db"; version="1.15.0"; sha256="1z9y7sraqikaxnkb4h3bx25fhm1llr0rzi4wg04nv8mjmy27p0dz"; depends=[MeSHDbi]; };
  MeSH_Ath_eg_db = derive2 { name="MeSH.Ath.eg.db"; version="1.15.0"; sha256="0i1fcasgmzsj4k1k7i8zgp25ywgkrpr9iwrl3r1lk6iwz70fq9pg"; depends=[MeSHDbi]; };
  MeSH_Bfl_eg_db = derive2 { name="MeSH.Bfl.eg.db"; version="1.15.0"; sha256="0cf9wklw5xkskz87d40d9sv26czxv1dnmzab9cj66viv7h8vzgly"; depends=[MeSHDbi]; };
  MeSH_Bsu_168_eg_db = derive2 { name="MeSH.Bsu.168.eg.db"; version="1.15.0"; sha256="00gfh6x8gbx77smmkw6bbqlmbaymzzamrqcjd29kqpa9npgvylnl"; depends=[MeSHDbi]; };
  MeSH_Bta_eg_db = derive2 { name="MeSH.Bta.eg.db"; version="1.15.0"; sha256="0zrs7m9582skcwqayxz2w73l16lv3fm0yk26aqi2gqvw75b5sn8z"; depends=[MeSHDbi]; };
  MeSH_Cal_SC5314_eg_db = derive2 { name="MeSH.Cal.SC5314.eg.db"; version="1.15.0"; sha256="1cbnslagmzm9gx12ay35ccbks9imra2yllgw79jagq38d78pdczs"; depends=[MeSHDbi]; };
  MeSH_Cbr_eg_db = derive2 { name="MeSH.Cbr.eg.db"; version="1.15.0"; sha256="0n44sin2dkyvz1jxqhaicdvmfzd5gbj7xbzvbvqw5w17k8gdxzj8"; depends=[MeSHDbi]; };
  MeSH_Cel_eg_db = derive2 { name="MeSH.Cel.eg.db"; version="1.15.0"; sha256="1jasx1fjwwpmas8xzysnnkphinbrdv5ykgispcck4gp5y6q253m0"; depends=[MeSHDbi]; };
  MeSH_Cfa_eg_db = derive2 { name="MeSH.Cfa.eg.db"; version="1.15.0"; sha256="0d2w94r521bfcgvd8zh69mmbf04yw6qzpzgi36a4an806j2x32yx"; depends=[MeSHDbi]; };
  MeSH_Cin_eg_db = derive2 { name="MeSH.Cin.eg.db"; version="1.15.0"; sha256="0477klxnxz637dics2csd4raw672db419i1793gm0zxaws3xv49a"; depends=[MeSHDbi]; };
  MeSH_Cja_eg_db = derive2 { name="MeSH.Cja.eg.db"; version="1.15.0"; sha256="1g0b7zdx454ckdhv89fwp6hjgmrbgjy83p75qx84lvj02cx57yb2"; depends=[MeSHDbi]; };
  MeSH_Cpo_eg_db = derive2 { name="MeSH.Cpo.eg.db"; version="1.15.0"; sha256="1ill5jzrwjs0n4sfidw505shcr5cvw11gkm646bkcv6g3nybrvkw"; depends=[MeSHDbi]; };
  MeSH_Cre_eg_db = derive2 { name="MeSH.Cre.eg.db"; version="1.15.0"; sha256="09i3qcvd14swdhgpv3j9b12zfvaimrml4w5ri9bk0s0w0s6c7wlw"; depends=[MeSHDbi]; };
  MeSH_Dan_eg_db = derive2 { name="MeSH.Dan.eg.db"; version="1.15.0"; sha256="1xya53rsf857vd7cykxz5xralmlcgn8mm5vsm3qnmy8ffilxpg0m"; depends=[MeSHDbi]; };
  MeSH_Dda_3937_eg_db = derive2 { name="MeSH.Dda.3937.eg.db"; version="1.15.0"; sha256="14w73m2qhvhrqpj4fs9ychc1zl6s7scl9baccbcybfv1n7lkxlwz"; depends=[MeSHDbi]; };
  MeSH_Ddi_AX4_eg_db = derive2 { name="MeSH.Ddi.AX4.eg.db"; version="1.15.0"; sha256="1mkpy2srkpgds8528jlaysvy3ch5kh9f06n5fyjrbdwnjq4l88dy"; depends=[MeSHDbi]; };
  MeSH_Der_eg_db = derive2 { name="MeSH.Der.eg.db"; version="1.15.0"; sha256="0qdimflvq01hvqfx715qxw32vah5v0a2k8l7zjkn60d4ck8ykhxq"; depends=[MeSHDbi]; };
  MeSH_Dgr_eg_db = derive2 { name="MeSH.Dgr.eg.db"; version="1.15.0"; sha256="0mrr8zx6hb5rd6j8514iy6kiqkirvr6mjhnfss3dcb3jgj6lax0f"; depends=[MeSHDbi]; };
  MeSH_Dme_eg_db = derive2 { name="MeSH.Dme.eg.db"; version="1.15.0"; sha256="0l6vnjvx2dw85g73d2fk3asvbal65iw7kilgxlcas89rwng0z7aw"; depends=[MeSHDbi]; };
  MeSH_Dmo_eg_db = derive2 { name="MeSH.Dmo.eg.db"; version="1.15.0"; sha256="1jyhrikbqnpd9wvdmlsxisp19xgl6wipznn9hgvk5h5my481cf50"; depends=[MeSHDbi]; };
  MeSH_Dpe_eg_db = derive2 { name="MeSH.Dpe.eg.db"; version="1.15.0"; sha256="1nkc51mnhqcrkgniy7j8s4s8llamqz0cidfc4n47jivfxprc369h"; depends=[MeSHDbi]; };
  MeSH_Dre_eg_db = derive2 { name="MeSH.Dre.eg.db"; version="1.15.0"; sha256="1jwlx1d36zrnlssrb7ppxjp0bnd75smib7j97fdbdwnshqlyqf3h"; depends=[MeSHDbi]; };
  MeSH_Dse_eg_db = derive2 { name="MeSH.Dse.eg.db"; version="1.15.0"; sha256="03r7792xc51vcha32qffbcqvphnn8fxmq4l01dgnc91pzzl4wiwp"; depends=[MeSHDbi]; };
  MeSH_Dsi_eg_db = derive2 { name="MeSH.Dsi.eg.db"; version="1.15.0"; sha256="0priqpr6kv5zvyb7zz1kmgpx0wkgsszd2wils1sixdjp91hmi13i"; depends=[MeSHDbi]; };
  MeSH_Dvi_eg_db = derive2 { name="MeSH.Dvi.eg.db"; version="1.15.0"; sha256="0w86nhasi0sd0zb8ryi33dh649k5jpwk1ya5nq98frzlz9d1dlj4"; depends=[MeSHDbi]; };
  MeSH_Dya_eg_db = derive2 { name="MeSH.Dya.eg.db"; version="1.15.0"; sha256="0cmr19xxydl594pjfhk0qniwfj62mkfnz943a67gdncdanyqgqf6"; depends=[MeSHDbi]; };
  MeSH_Eca_eg_db = derive2 { name="MeSH.Eca.eg.db"; version="1.15.0"; sha256="0547q39aig8y860kapn1n5r8yv5vakmfi4ija5192nrxnpc1b0sp"; depends=[MeSHDbi]; };
  MeSH_Eco_55989_eg_db = derive2 { name="MeSH.Eco.55989.eg.db"; version="1.13.1"; sha256="1k9zzq5igi4dd92zfaniv8l4hr0b1381wn20ybnc1zl68qgnc6c4"; depends=[MeSHDbi]; };
  MeSH_Eco_ED1a_eg_db = derive2 { name="MeSH.Eco.ED1a.eg.db"; version="1.13.1"; sha256="0vvi9shain6wqsrs32hzhpwssw5wfsxcq3zq648amhs114slql28"; depends=[MeSHDbi]; };
  MeSH_Eco_IAI39_eg_db = derive2 { name="MeSH.Eco.IAI39.eg.db"; version="1.13.1"; sha256="0w4dsd2f85qaglqwb1ls94ncinsdhvaxhb8l5vqs7yg3ins23kam"; depends=[MeSHDbi]; };
  MeSH_Eco_K12_MG1655_eg_db = derive2 { name="MeSH.Eco.K12.MG1655.eg.db"; version="1.15.0"; sha256="1pdhkdn4navl5jyqdq9p1mb5yzmpjjngkv5br381pmiy5slg5psi"; depends=[MeSHDbi]; };
  MeSH_Eco_O157_H7_Sakai_eg_db = derive2 { name="MeSH.Eco.O157.H7.Sakai.eg.db"; version="1.15.0"; sha256="1d6cz0ldkasmdqzsk05ifxxg1qji2sb7dms31ibrhr4ds03y4843"; depends=[MeSHDbi]; };
  MeSH_Eco_UMN026_eg_db = derive2 { name="MeSH.Eco.UMN026.eg.db"; version="1.13.1"; sha256="0c3ndl270kd3v7az7dm3ng812nvr85srgxmazhxrfbk0fay962ln"; depends=[MeSHDbi]; };
  MeSH_Eqc_eg_db = derive2 { name="MeSH.Eqc.eg.db"; version="1.13.1"; sha256="1gavxbp6n5jgdhgnm4a2rqfh7rphk2k58pcyk23ldla2mbp2c4fm"; depends=[MeSHDbi]; };
  MeSH_Gga_eg_db = derive2 { name="MeSH.Gga.eg.db"; version="1.15.0"; sha256="0lflpha24bnlppjjv722nn679hz2fhvsff57y5i9jfkbliyq4ccy"; depends=[MeSHDbi]; };
  MeSH_Gma_eg_db = derive2 { name="MeSH.Gma.eg.db"; version="1.15.0"; sha256="06j0i8nj0093nagr6lhzzszmhdnxmn38c0l7gjdmc48byrpilx18"; depends=[MeSHDbi]; };
  MeSH_Hsa_eg_db = derive2 { name="MeSH.Hsa.eg.db"; version="1.15.0"; sha256="1kzxwp5sy48qa1aav17m8g7bakdc51f3dfigyp6dp0yc2g30wvxp"; depends=[MeSHDbi]; };
  MeSH_Laf_eg_db = derive2 { name="MeSH.Laf.eg.db"; version="1.15.0"; sha256="1ndc46ys5js4pn014dbm2432p7n0mzrjd09nhxpxd4jg7rj5b79s"; depends=[MeSHDbi]; };
  MeSH_Lma_eg_db = derive2 { name="MeSH.Lma.eg.db"; version="1.15.0"; sha256="1zs7qsx7bryrcqclmfj39vhl6qbvm0zyw4h2nh23ypapjl8kf81x"; depends=[MeSHDbi]; };
  MeSH_Mdo_eg_db = derive2 { name="MeSH.Mdo.eg.db"; version="1.15.0"; sha256="1yls5fwk4ch8rla7ry2l0gajhlqb26iz9gcb4sy9mymlnck4fy28"; depends=[MeSHDbi]; };
  MeSH_Mes_eg_db = derive2 { name="MeSH.Mes.eg.db"; version="1.15.0"; sha256="1lmag4gj8gps7wpnxdafkz5fxlswcfikgzslr93mzg38653ka1nc"; depends=[MeSHDbi]; };
  MeSH_Mga_eg_db = derive2 { name="MeSH.Mga.eg.db"; version="1.15.0"; sha256="1cvrcga9kcvznff22z89g7sp1jhmyh74wyrznc1i8l80dackhzff"; depends=[MeSHDbi]; };
  MeSH_Miy_eg_db = derive2 { name="MeSH.Miy.eg.db"; version="1.15.0"; sha256="0l05y7zi1jwj6m1mzfi8kzp1nfcp5q1nq7w9w4ghr3hjxv2mg7w0"; depends=[MeSHDbi]; };
  MeSH_Mml_eg_db = derive2 { name="MeSH.Mml.eg.db"; version="1.15.0"; sha256="1zppv4fr2sjql32k4mc0c6qdm5f97i9aacyfgrjpkhba5qrsyfpv"; depends=[MeSHDbi]; };
  MeSH_Mmu_eg_db = derive2 { name="MeSH.Mmu.eg.db"; version="1.15.0"; sha256="0ycihsvi9qvs5bd5qrm1m27rzhpiyf6vjfi4srs7lplp9z329z8m"; depends=[MeSHDbi]; };
  MeSH_Mtr_eg_db = derive2 { name="MeSH.Mtr.eg.db"; version="1.15.0"; sha256="13dwj7v6i3qc2gpsvf9ra9zz5k7plk5ldld43a1wb614bjszywb2"; depends=[MeSHDbi]; };
  MeSH_Nle_eg_db = derive2 { name="MeSH.Nle.eg.db"; version="1.15.0"; sha256="0bqwc68wkh9zbmrgx7rb2383axlbizg2m65qzr8s6zizqawm7lif"; depends=[MeSHDbi]; };
  MeSH_Oan_eg_db = derive2 { name="MeSH.Oan.eg.db"; version="1.15.0"; sha256="0a4j83v2hk6y8bxjyzb516d12h4ymhmwpj5cs03cf5xd9mwwbb7b"; depends=[MeSHDbi]; };
  MeSH_Ocu_eg_db = derive2 { name="MeSH.Ocu.eg.db"; version="1.15.0"; sha256="0aqqz0arrrs0pcljdhr30ixsbsh79f9ywifyrs00hfngnb2fg45l"; depends=[MeSHDbi]; };
  MeSH_Oni_eg_db = derive2 { name="MeSH.Oni.eg.db"; version="1.15.0"; sha256="1rgjayw05ggcqli9991ix3kmjv5fxiz7c3s5yy889libl70qhsqd"; depends=[MeSHDbi]; };
  MeSH_Osa_eg_db = derive2 { name="MeSH.Osa.eg.db"; version="1.15.0"; sha256="01w6z5krfikrsndj9qsq6vx6yzwcwhjs2bj3hmyjm4yyryjap2xy"; depends=[MeSHDbi]; };
  MeSH_PCR_db = derive2 { name="MeSH.PCR.db"; version="1.15.0"; sha256="0370mrz00k2zlapxrgf74m7sx3jas977dkp5x694b8y6c1qv6gc3"; depends=[MeSHDbi]; };
  MeSH_Pab_eg_db = derive2 { name="MeSH.Pab.eg.db"; version="1.15.0"; sha256="07hjznch109aslky2nhj1pk565mkcc6hr5jphc5njakcjflbwbdn"; depends=[MeSHDbi]; };
  MeSH_Pae_PAO1_eg_db = derive2 { name="MeSH.Pae.PAO1.eg.db"; version="1.15.0"; sha256="0gb5rcgg2653jbz0l6z8672vldb7jpq66y2kfmsj5bsw6s9xc7xm"; depends=[MeSHDbi]; };
  MeSH_Pfa_3D7_eg_db = derive2 { name="MeSH.Pfa.3D7.eg.db"; version="1.15.0"; sha256="1j7a4ghdzr87s2qnrjsaf3611wb3cik2irrr9mxfbnxqy4yxyfxa"; depends=[MeSHDbi]; };
  MeSH_Pto_eg_db = derive2 { name="MeSH.Pto.eg.db"; version="1.15.0"; sha256="0azkfrilcnxnz96kl5b1vmbw1yc6k4vjkqcrh1gpnkivlxww616f"; depends=[MeSHDbi]; };
  MeSH_Ptr_eg_db = derive2 { name="MeSH.Ptr.eg.db"; version="1.15.0"; sha256="0nz2chxy5wqp0jfmlgam73qvz2d2ypfqr2gjzb4rj9c5q20y75jj"; depends=[MeSHDbi]; };
  MeSH_Rno_eg_db = derive2 { name="MeSH.Rno.eg.db"; version="1.15.0"; sha256="0bsic8fhv7cyzlcfbis1rrkvf9r3f4735pg62ypczvdj2yx1pqag"; depends=[MeSHDbi]; };
  MeSH_Sce_S288c_eg_db = derive2 { name="MeSH.Sce.S288c.eg.db"; version="1.15.0"; sha256="0rkjl2m7sjdck3037aj69c37wbknjlbfcx59sb86mspv7q33fhpc"; depends=[MeSHDbi]; };
  MeSH_Sco_A32_eg_db = derive2 { name="MeSH.Sco.A32.eg.db"; version="1.15.0"; sha256="0w396xl2yq960yfw55vr0n4d7152w65lkd73jblwk5zqwig6f5qg"; depends=[MeSHDbi]; };
  MeSH_Sil_eg_db = derive2 { name="MeSH.Sil.eg.db"; version="1.15.0"; sha256="1dy218w8ry9v9yry5fvkkahdh73aa9gd3nlizdkfs901v2pg2fcp"; depends=[MeSHDbi]; };
  MeSH_Spu_eg_db = derive2 { name="MeSH.Spu.eg.db"; version="1.15.0"; sha256="0gv9sslvq0dgfgfl04kvhkyzqfi8napkwbisdkfg21x03id16481"; depends=[MeSHDbi]; };
  MeSH_Ssc_eg_db = derive2 { name="MeSH.Ssc.eg.db"; version="1.15.0"; sha256="1xcnjn70qbr2fmsw715wifl61021ghdyhil8nlylm3ydj89qwv6g"; depends=[MeSHDbi]; };
  MeSH_Syn_eg_db = derive2 { name="MeSH.Syn.eg.db"; version="1.15.0"; sha256="1l0ylw0i6900ikmlb8z1vi94745cbgj3imfj8xys9r8cdgnzn16j"; depends=[MeSHDbi]; };
  MeSH_Tbr_9274_eg_db = derive2 { name="MeSH.Tbr.9274.eg.db"; version="1.15.0"; sha256="0240iq4fdbi03s36pffbgm375g3ch4gqsyjs79wlhqg7bizvsr93"; depends=[MeSHDbi]; };
  MeSH_Tgo_ME49_eg_db = derive2 { name="MeSH.Tgo.ME49.eg.db"; version="1.15.0"; sha256="1qa7w7v301pi6lmd31afzvgrxmvs504054hq6rzr33ix5gm035ny"; depends=[MeSHDbi]; };
  MeSH_Tgu_eg_db = derive2 { name="MeSH.Tgu.eg.db"; version="1.15.0"; sha256="0s0442s9z09bcxdbskrg9myqjghl1mk1mysyl90dczv0mfl0hrqd"; depends=[MeSHDbi]; };
  MeSH_Vvi_eg_db = derive2 { name="MeSH.Vvi.eg.db"; version="1.15.0"; sha256="1h807bbzx1f916myi5p1xanvbffygdj2vghhf3spf8bcdm3avcgn"; depends=[MeSHDbi]; };
  MeSH_Xla_eg_db = derive2 { name="MeSH.Xla.eg.db"; version="1.15.0"; sha256="055pa2wjm587f2vik92x1fhrk23zhy85sbrbfq2zznikvfjlbf7v"; depends=[MeSHDbi]; };
  MeSH_Xtr_eg_db = derive2 { name="MeSH.Xtr.eg.db"; version="1.15.0"; sha256="1yr3s3b6ds75xrsg9srdkcg53d72wna2cnx5xn9932887125cybx"; depends=[MeSHDbi]; };
  MeSH_Zma_eg_db = derive2 { name="MeSH.Zma.eg.db"; version="1.15.0"; sha256="1c0xg9adpiwbwmwaak90pkh2vpakpvwjan2dgj89cxv0v2g5kn7q"; depends=[MeSHDbi]; };
  MeSH_db = derive2 { name="MeSH.db"; version="1.15.0"; sha256="165vdjc9gikwnyvihvkci0n5gbxyna962yiyi21qd4csvin12qzz"; depends=[MeSHDbi]; };
  ...
  PFAM_db = derive2 { name="PFAM.db"; version="3.12.0"; sha256="1s9gdyqxbr944ksr1n7ik15qmh6sq264z3d77iyjvbrba9kx0hpc"; depends=[AnnotationDbi]; };
  ...
  anopheles_db0 = derive2 { name="anopheles.db0"; version="3.12.0"; sha256="07xdk002a41yj79d60a63l5wmyyz2x9py89nh2hnsqm2cvx90wk2"; depends=[AnnotationDbi]; };
  arabidopsis_db0 = derive2 { name="arabidopsis.db0"; version="3.12.0"; sha256="01cg5g8ikgim46s470hp7g6pnln8szwr1pmpysyad3w4ipd03asl"; depends=[AnnotationDbi]; };
  ...
  bovine_db0 = derive2 { name="bovine.db0"; version="3.12.0"; sha256="04mzghsr386fs3wr97cdnzclcynxpmmj3zklx4cjhl9q28jvk1nd"; depends=[AnnotationDbi]; };
  ...
  canine_db0 = derive2 { name="canine.db0"; version="3.12.0"; sha256="09y3l6ilc7r6m9ghvfsz5xw1m9xl608x9gwbfz9rq33dszvmmssd"; depends=[AnnotationDbi]; };
  ...
  chicken_db0 = derive2 { name="chicken.db0"; version="3.12.0"; sha256="1qsnbxd79cvwkj5883p2ya57afkknsnyps11iy0qhl5jinvywi6l"; depends=[AnnotationDbi]; };
  ...
  chimp_db0 = derive2 { name="chimp.db0"; version="3.12.0"; sha256="05hvlfikgbbhc3a6h2bf7d3n7dqs5jk6qbxg8pk7bcbj17xndacq"; depends=[AnnotationDbi]; };
  ...
  ecoliK12_db0 = derive2 { name="ecoliK12.db0"; version="3.12.0"; sha256="0by1l28is01a5pbg5clci9vk54nihfbddi3ffn9rav1673l3qm1x"; depends=[AnnotationDbi]; };
  ecoliSakai_db0 = derive2 { name="ecoliSakai.db0"; version="3.12.0"; sha256="0zyp0vk5kvb1jkmj2a5qmylh9m33a1lmg6vm1k5g7ln9fah130bg"; depends=[AnnotationDbi]; };
  ...
  fly_db0 = derive2 { name="fly.db0"; version="3.12.0"; sha256="1q4i4hg3aap8553jsb4w02p3vbd3pc4w5ry0cpicd3zh1w7bn846"; depends=[AnnotationDbi]; };
  ...
  human_db0 = derive2 { name="human.db0"; version="3.12.0"; sha256="1szqvcns639cw5l727bhla2blz36x0i6xkdzw3dl5nwm0p2qiy59"; depends=[AnnotationDbi]; };
  ...
  malaria_db0 = derive2 { name="malaria.db0"; version="3.12.0"; sha256="1jbxvm3v8phyhqywm5plx0sjdgd0cn47fbsqxgmpmzyav8kilanz"; depends=[AnnotationDbi]; };
  ...
  metaboliteIDmapping = derive2 { name="metaboliteIDmapping"; version="0.99.8"; sha256="0aywrh84a0qcgrjc4zp7j73xdb8fhgxkmsly0qnl2fwarmzzvlkj"; depends=[AnnotationHub]; };
  ...
  mouse_db0 = derive2 { name="mouse.db0"; version="3.12.0"; sha256="0lyah05kdgx5sf2hn6p6ac8b922qg1lf5m13rpixvv6362cn4wk3"; depends=[AnnotationDbi]; };
  ...
  org_Ag_eg_db = derive2 { name="org.Ag.eg.db"; version="3.12.0"; sha256="1cc7iy9wsrcvz94p70gvkacwmzw42g2nxpwyzlcb3f3cc5a8kzb2"; depends=[AnnotationDbi]; };
  org_At_tair_db = derive2 { name="org.At.tair.db"; version="3.12.0"; sha256="0ggv68p5ly1pbxai62mlajkgyxh8wc5as5xikm03s7sqj99fl9zj"; depends=[AnnotationDbi]; };
  org_Bt_eg_db = derive2 { name="org.Bt.eg.db"; version="3.12.0"; sha256="1brx8m6cpmkkaf3f1rmxb3payln342cmkhbp4z8mx6n82jjnvx0l"; depends=[AnnotationDbi]; };
  org_Ce_eg_db = derive2 { name="org.Ce.eg.db"; version="3.12.0"; sha256="0nq4g94jp1pg15lrl430iq7545lgxp2c3af03cq77rx2b5pfn0im"; depends=[AnnotationDbi]; };
  org_Cf_eg_db = derive2 { name="org.Cf.eg.db"; version="3.12.0"; sha256="0w18zxd9pbwcsmz1ilddywhd225mv3975imq0kihc84hzlca9gh0"; depends=[AnnotationDbi]; };
  org_Dm_eg_db = derive2 { name="org.Dm.eg.db"; version="3.12.0"; sha256="1mys35qrvjff1xnr7xrgf9rmpamdia9p54p6y73bhxs7q9x6sl7c"; depends=[AnnotationDbi]; };
  org_Dr_eg_db = derive2 { name="org.Dr.eg.db"; version="3.12.0"; sha256="0kay0vsbvymrva7d11qq5rwi67lfmprrpi1zrzrgdx24xnv9fdkl"; depends=[AnnotationDbi]; };
  org_EcK12_eg_db = derive2 { name="org.EcK12.eg.db"; version="3.12.0"; sha256="0c4p6jr83k0gm6pvn760yr8xf33wggrfcr6fg7a42a96bcf817gs"; depends=[AnnotationDbi]; };
  org_EcSakai_eg_db = derive2 { name="org.EcSakai.eg.db"; version="3.12.0"; sha256="1rali3pahng83lakv80bp0vi5gisykbc4y77mx1ap7hiv9vnyaiz"; depends=[AnnotationDbi]; };
  org_Gg_eg_db = derive2 { name="org.Gg.eg.db"; version="3.12.0"; sha256="11240bskl0cmkrr4238gmkbb0kc85dmb5sv5f3mlg77a4qhj4wm4"; depends=[AnnotationDbi]; };
  org_Hs_eg_db = derive2 { name="org.Hs.eg.db"; version="3.12.0"; sha256="1fs9680g03w9r3jjcn3nlbzn2aqh6fiapnamql18cypc8x9sp8a8"; depends=[AnnotationDbi]; };
  org_Mm_eg_db = derive2 { name="org.Mm.eg.db"; version="3.12.0"; sha256="013c69b7h2vcv6h3jp0a26p9dkr1wj9599bh34xiyfns1z242lvl"; depends=[AnnotationDbi]; };
  org_Mmu_eg_db = derive2 { name="org.Mmu.eg.db"; version="3.12.0"; sha256="053cg979pwkvas8sip0a5q6rrbkzh5d9wv4420r3mv4sdg7q3kfc"; depends=[AnnotationDbi]; };
  ...
  org_Pf_plasmo_db = derive2 { name="org.Pf.plasmo.db"; version="3.12.0"; sha256="0vka0m5x2g6cw2p0zkk602zic8gzqsb23p622d0v8kwb5zpmb7c5"; depends=[AnnotationDbi]; };
  org_Pt_eg_db = derive2 { name="org.Pt.eg.db"; version="3.12.0"; sha256="1zvlnqyywkp07nkryzlmykbzdisnbafy0i9ws9slq8dhjhacgxj1"; depends=[AnnotationDbi]; };
  org_Rn_eg_db = derive2 { name="org.Rn.eg.db"; version="3.12.0"; sha256="1ia6bbfkcl4f9hxrckbpq46r5i3l9zf8bvq4xggm82gwc5bn9pab"; depends=[AnnotationDbi]; };
  org_Sc_sgd_db = derive2 { name="org.Sc.sgd.db"; version="3.12.0"; sha256="1vflhhgg59gdnidcbn8vkia87impcz28vv98i17821rhkw1i8fss"; depends=[AnnotationDbi]; };
  org_Ss_eg_db = derive2 { name="org.Ss.eg.db"; version="3.12.0"; sha256="04rvpx63s45dx5k067q5fhrqs34s4gcb3xv0h0ixrg76ns1nrmbl"; depends=[AnnotationDbi]; };
  org_Xl_eg_db = derive2 { name="org.Xl.eg.db"; version="3.12.0"; sha256="0chr3agh0q79m7ang9vdf87p60k1kxcjamnwxf9gf2avrawlp05m"; depends=[AnnotationDbi]; };
  ...
  pig_db0 = derive2 { name="pig.db0"; version="3.12.0"; sha256="14v6sjpgk2qxkp5mkq6wbdb1wv2hv8xmmhsrbsrnhf3iflqrq41p"; depends=[AnnotationDbi]; };
  ...
  ragene11sttranscriptcluster_db = derive2 { name="ragene11sttranscriptcluster.db"; version="8.7.0"; sha256="195dx0splkvdwqn4h6nvmm3zd0sv3vhcjz1bp1qxgi6d5iakvkry"; depends=[AnnotationDbi org_Rn_eg_db]; };
  ragene20stprobeset_db = derive2 { name="ragene20stprobeset.db"; version="8.7.0"; sha256="1p8qiqwxpkq2784ixzdd9pq38nrb4x8qwfmk5alr225br4vv0k2q"; depends=[AnnotationDbi org_Rn_eg_db]; };
  ...
  rat_db0 = derive2 { name="rat.db0"; version="3.12.0"; sha256="0p9jnh0k379x6agqphi9lwmznvv8nv0k1s1qpnfh4d801pdcnk0l"; depends=[AnnotationDbi]; };
  ...
  reactome_db = derive2 { name="reactome.db"; version="1.74.0"; sha256="05ip70gik4f5r5bs36mkdlzcrxgn39inp7430j4kcqqa5j4svv8z"; depends=[AnnotationDbi]; };
  ...
  rhesus_db0 = derive2 { name="rhesus.db0"; version="3.12.0"; sha256="0rcj9xml2rdhyz77iggnimijx4ia0nwf9sm8wzjjlwlkb522gvi3"; depends=[AnnotationDbi]; };
  ...
  worm_db0 = derive2 { name="worm.db0"; version="3.12.0"; sha256="021fck9gd3jy1a15n4x3l59qfvw0xr2dg0v7cwza857nhrbh7y5n"; depends=[AnnotationDbi]; };
  xenopus_db0 = derive2 { name="xenopus.db0"; version="3.12.0"; sha256="0ml6skgvhjr4fssnc0x6rz1z6qg1lnxppw7478g3233cfmw8ymfi"; depends=[AnnotationDbi]; };
  ...
  yeast_db0 = derive2 { name="yeast.db0"; version="3.12.0"; sha256="0mgyb650gs1bfnlvd115jhj3ypyfmwql5dj864sv9svxcdysc212"; depends=[AnnotationDbi]; };
  ...
  zebrafish_db0 = derive2 { name="zebrafish.db0"; version="3.12.0"; sha256="1rv3x6h593caw2ml267803qm14nh34dfn301pzznbf6zvd61v6dg"; depends=[AnnotationDbi]; };
  ...
  AHLRBaseDbs = derive2 { name="AHLRBaseDbs"; version="1.0.0"; sha256="06y0ikhf3dslxgbk909p7f8ml7zm2ikrkhz06bkjp0i7kprlwz2p"; depends=[AnnotationHub]; broken = true; };
  AHMeSHDbs = derive2 { name="AHMeSHDbs"; version="1.0.0"; sha256="17srmg1q5k9x46f0z5k7lkszznl0k5xs0vm4jnsj9c9bimy0pg50"; depends=[AnnotationHub]; broken = true; };
  AHPathbankDbs = derive2 { name="AHPathbankDbs"; version="0.99.5"; sha256="10wcrglm521xcrfbzc39dkbjvg1pkz0zq70vgnh68akiwmdirp89"; depends=[AnnotationHub]; broken = true; };
  AHPubMedDbs = derive2 { name="AHPubMedDbs"; version="0.99.8"; sha256="0c9x07i3pmr7rd7i76hmzk2zjfi091p575q75kyy3jmxd0dpgcac"; depends=[AnnotationHub]; broken = true; };
  AHWikipathwaysDbs = derive2 { name="AHWikipathwaysDbs"; version="0.99.4"; sha256="0vz3p9sx36bwzl9rq0ffh7klbq13pv2yhgjq1cjk7ll8z226c0q4"; depends=[AnnotationHub]; broken = true; };
  BSgenome_Hsapiens_UCSC_hg38_dbSNP151_major = derive2 { name="BSgenome.Hsapiens.UCSC.hg38.dbSNP151.major"; version="0.0.9999"; sha256="1nnz1wr2c185zjq7k5yn3fwcfc63lj068lbkxy831sd6j2z0mglv"; depends=[BSgenome]; broken = true; };
  BSgenome_Hsapiens_UCSC_hg38_dbSNP151_minor = derive2 { name="BSgenome.Hsapiens.UCSC.hg38.dbSNP151.minor"; version="0.0.9999"; sha256="1ynqclar5vb1r7l1zsnfdqrd1hjs94w5gxds4ds28q8j45h4rywd"; depends=[BSgenome]; broken = true; };
  BSgenome_Rnorvegicus_UCSC_rn7 = derive2 { name="BSgenome.Rnorvegicus.UCSC.rn7"; version="1.4.3"; sha256="0bgmgxk5rq6m42z0mcpvq9i7r8rid3ws80jx5g9kkklv5kglfidy"; depends=[BSgenome]; broken = true; };
  MafH5_gnomAD_v3_1_1_GRCh38 = derive2 { name="MafH5.gnomAD.v3.1.1.GRCh38"; version="3.13.0"; sha256="1fqw3qv4cw043ifyrcddsq3z13y4gk12cg7j39bg1am3msa7zmbg"; depends=[BSgenome GenomeInfoDb GenomicRanges GenomicScores HDF5Array IRanges rhdf5 S4Vectors]; broken = true; };
  Orthology_eg_db = derive2 { name="Orthology.eg.db"; version="3.13.0"; sha256="0205lwgdh94ha4dsr4qm9ypa6i433swlqda5bgn1hrkgz0bizbnw"; depends=[AnnotationDbi]; broken = true; };
  TxDb_Hsapiens_UCSC_hg38_refGene = derive2 { name="TxDb.Hsapiens.UCSC.hg38.refGene"; version="3.13.0"; sha256="07b1bxg17kql6kivwz2gwwjfk9b052q610jciw7c2g4lr425x7ja"; depends=[AnnotationDbi GenomicFeatures]; broken = true; };
  gwascatData = derive2 { name="gwascatData"; version="0.99.6"; sha256="1xhmzl06vivq8x01h60q3c4vql67wjgjfs35j4ifmixp1qhicgga"; depends=[data_table]; broken = true; };
  hthgu133plusa_db = derive2 { name="hthgu133plusa.db"; version="3.13.0"; sha256="0jym9djj7mm0smgk1sibkvf0xch06hlhpyqmwji24hl7b9flb7vd"; depends=[AnnotationDbi org_Hs_eg_db]; broken = true; };
  hthgu133plusb_db = derive2 { name="hthgu133plusb.db"; version="3.13.0"; sha256="0hkfsdjpzbki8jc16bhvqspyg9dzi89shs14lz67d0id504iirrm"; depends=[AnnotationDbi org_Hs_eg_db]; broken = true; };
  hthgu133pluspm_db = derive2 { name="hthgu133pluspm.db"; version="3.13.0"; sha256="1g11zfvh7l8qmgdpsdbvbn83zqz37g4fiz5yllqa26jpr23a708z"; depends=[AnnotationDbi org_Hs_eg_db]; broken = true; };
  htmg430a_db = derive2 { name="htmg430a.db"; version="3.13.0"; sha256="0lsaplzk1myhsdsagsbql4q95yhli3myhhczlzn415pqvx7ykmnj"; depends=[AnnotationDbi org_Mm_eg_db]; broken = true; };
  htmg430b_db = derive2 { name="htmg430b.db"; version="3.13.0"; sha256="1iyvqnw3aqjnik3jmw7cn83czyny832xh3jfvgffmi305rydk5i5"; depends=[AnnotationDbi org_Mm_eg_db]; broken = true; };
  htmg430pm_db = derive2 { name="htmg430pm.db"; version="3.13.0"; sha256="0q1dczr4kcq15v63r4mbap5cxc79l5k76rggh28g623dp215l0cx"; depends=[AnnotationDbi org_Mm_eg_db]; broken = true; };
  htrat230pm_db = derive2 { name="htrat230pm.db"; version="3.13.0"; sha256="17v7irq01lxb1gl16mx2syyqvan10fjzsl4712l47khiscyi8jxk"; depends=[AnnotationDbi org_Rn_eg_db]; broken = true; };
  htratfocus_db = derive2 { name="htratfocus.db"; version="3.13.0"; sha256="0b7qfdp9mdqgphs7j3vh1xbyw2zkw8and9q4mmj2yd2kdkm23r79"; depends=[AnnotationDbi org_Rn_eg_db]; broken = true; };
}
