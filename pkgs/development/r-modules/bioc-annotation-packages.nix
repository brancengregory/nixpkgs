...
in with self; {
  ...
  LRBase_Ath_eg_db = derive2 { name="LRBase.Ath.eg.db"; version="1.0.0"; sha256="1bqjzplyri0jqwchpss64l1kqqxrp3v36isd74aqww4isqg4l3bv"; depends=[LRBaseDbi RSQLite]; };
  LRBase_Bta_eg_db = derive2 { name="LRBase.Bta.eg.db"; version="1.0.0"; sha256="1m0kb6f1d00ff89l9f0ai23fi13qbhh998kw5pc9mamq9px9kghv"; depends=[LRBaseDbi RSQLite]; };
  LRBase_Cel_eg_db = derive2 { name="LRBase.Cel.eg.db"; version="1.0.0"; sha256="14fkjcpsj5wbh0ln15gl1myl8a478rpdzm5g53i54n0sf4cl7xlw"; depends=[LRBaseDbi RSQLite]; };
  LRBase_Dme_eg_db = derive2 { name="LRBase.Dme.eg.db"; version="1.0.0"; sha256="0mg0jz0xjyj8gppf1dz5yxa4ac3rwhp3rz3zm53vxyw8589g93hr"; depends=[LRBaseDbi RSQLite]; };
  LRBase_Dre_eg_db = derive2 { name="LRBase.Dre.eg.db"; version="1.0.0"; sha256="0x4wpby9y16jrpkxb2681njhazxdmzxadx00v3j5wy7kx92hd495"; depends=[LRBaseDbi RSQLite]; };
  LRBase_Gga_eg_db = derive2 { name="LRBase.Gga.eg.db"; version="1.0.0"; sha256="10wrsibb59wvhp9nd3fzikbyqjj4bgrbp6h0fqrmh7bars595611"; depends=[LRBaseDbi RSQLite]; };
  LRBase_Hsa_eg_db = derive2 { name="LRBase.Hsa.eg.db"; version="1.0.0"; sha256="0vmjva42n1b12ka0gfmfvsfipjk5dmxr0cg21ag5n00flbny6msk"; depends=[LRBaseDbi RSQLite]; };
  LRBase_Mmu_eg_db = derive2 { name="LRBase.Mmu.eg.db"; version="1.0.0"; sha256="1z0bs6hadakkck0w9hzb1gjmxrsghk6awbvgazyschxi9gmb6mjp"; depends=[LRBaseDbi RSQLite]; };
  LRBase_Pab_eg_db = derive2 { name="LRBase.Pab.eg.db"; version="1.0.0"; sha256="0xxgiw7bnxyrg86xn1njjcvap8k54zjh1f7hxjv7348828z3l6ib"; depends=[LRBaseDbi RSQLite]; };
  LRBase_Rno_eg_db = derive2 { name="LRBase.Rno.eg.db"; version="1.0.0"; sha256="1bi4fdxsfh234zfcwlxsdr2ynvv0xgffmh35fr0wk4d3hv642qzb"; depends=[LRBaseDbi RSQLite]; };
  LRBase_Ssc_eg_db = derive2 { name="LRBase.Ssc.eg.db"; version="1.0.0"; sha256="0398fw527j02s7qf88svkvn9zpnh1j1lq0mjxis6hw5jcqfsabbl"; depends=[LRBaseDbi RSQLite]; };
  LRBase_Xtr_eg_db = derive2 { name="LRBase.Xtr.eg.db"; version="1.0.0"; sha256="05ldr8b7y6jr8ficr9wq704m8v732bdnh4i2vlhgnsi0hxqfnf7c"; depends=[LRBaseDbi RSQLite]; };
  ...
  hpAnnot = derive2 { name="hpAnnot"; version="0.99.9"; sha256="0ssvqclrksd8k6qgn0s8ya7w9qyr1jdfhgrq7a8h1qinc9dcxlb3"; depends=[]; };
