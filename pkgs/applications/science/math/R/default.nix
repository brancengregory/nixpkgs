...
stdenv.mkDerivation (finalAttrs: {
  ...
  buildInputs = [
    ...
    pango pcre2 perl gfortran readline (texliveSmall.withPackages (ps: with ps; [ inconsolata helvetic ps.texinfo fancyvrb cm-super rsfs ])) xz zlib less texinfo graphviz icu
  ...
  '' + lib.optionalString stdenv.hostPlatform.isDarwin ''
      ...
      LDFLAGS="-L${lib.getLib stdenv.cc.libcxx}/lib -L${lib.getLib gfortran}/lib -Wl,-rpath,${lib.getLib gfortran}/lib"
  '' + ''
    )
